...
from MatchGameSim import TLGRP90, TLGRP90HA, match_simulation, match_simulation_30, match_simulation_wc, match_simulation_30_wc
...
def TLKO_simulation_wc_8(number_of_matches, time_delay, player_data, nation_data, active_data, section_data):
    for a in range(number_of_matches):
        et_goals1, et_goals2 = 0, 0
        time.sleep(time_delay)
        print("MATCH", a + 1, "\n")
        ...
        if (a % 2) == 0:
            team1 = active_data.loc[(2 * a), 'Country']
            team2 = active_data.loc[(2 * a + 2), 'Country']
            a1, d1 = active_data.loc[(2 * a), 'Attack'], active_data.loc[(2 * a), 'Defence']
            a2, d2 = active_data.loc[(2 * a + 2), 'Attack'], active_data.loc[(2 * a + 2), 'Defence']
            ...
            if goals1 < goals2:
                df = active_data.iloc[(2 * a + 2):(2 * a) + 3, :]
                section_data = pd.concat([section_data, df])
